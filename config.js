...
global.info = {
 nomerbot: '212705283426',
 pairingNumber: '212639319505',
 nameown: 'ZA ID LH',
 nomerown: '212639319505',
 packname: 'sticker by ',
 author: 'ZA ID LH',
 namebot: '❖Ƭʜᴇ🆉🅰 🅱🅾🆃ヅ',
 wm: '❖Ƭʜᴇ🆉🅰 🅱🅾🆃ヅ',
...
// Sosmed
global.url = {
 sig: 'https://instagram.com/za__id__lh',
 sgh:  'https://github.com/noureddineouafy',
 sgc: 'https://chat.whatsapp.com/GEZF4aNxmAG2f8EeLYJPVs'
}
...
global.msg = {
 ...
 eror: '🤖*Bot Information*\n\> Sorry for the inconvenience in using *❖Ƭʜᴇ🆉🅰 🅱🅾🆃ヅ*. There was an error in the system while executing the command.'
}
